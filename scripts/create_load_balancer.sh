...
gcloud compute network-endpoint-groups create wefly-api-server-neg --region=asia-northeast1 --network-endpoint-type=serverless --cloud-run-service=wefly-client
gcloud compute network-endpoint-groups create wefly-client-neg --region=asia-northeast1 --network-endpoint-type=serverless --cloud-run-service=wefly-api-server
...
gcloud compute url-maps import wefly-url-map --global --source=../url-map.yml
