...
gcloud compute network-endpoint-groups delete wefly-client-neg --region=asia-northeast1 --quiet
gcloud compute network-endpoint-groups delete wefly-api-server-neg --region=asia-northeast1 --quiet